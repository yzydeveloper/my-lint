    ...
    return [
        {
            ...
            rules: {
                ...
                // e18e/prefer-static-regex is too strict for non-lib projects, and most of the time
                // the performance improvement is negligible, so we'll disable it by default for app projects.
                ...(type === 'lib'
                    ? {}
                    : {
