...
export async function formatters(
    ...
    const dprintOptions = {
        ...
        useTabs: indent === 'tab',
        // TODO: refine the type of `resolvedOptions.dprintOptions` in the future to avoid this ts comment.
        // @ts-expect-error - `resolvedOptions.dprintOptions` is boolean
