...
const isCwdInScope = isPackageExists('@yzydeveloper/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@yzydeveloper/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@yzydeveloper/eslint-config'
